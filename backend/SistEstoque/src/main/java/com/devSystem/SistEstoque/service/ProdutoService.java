...
public class ProdutoService {
    ...
    @Autowired
    public ProdutoService(ProdutoRepository repositorioProduto, EstoqueService servicoEstoque,
                          DoadorRepository repositorioDoador, FabricanteRepository repositorioFabricante,
