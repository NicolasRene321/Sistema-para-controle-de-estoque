...
public class EntregaProduto {
    ...
    public EntregaProduto(Long codEntrega, LocalDate dataEntrega, String nomeProdutoEntrega,
                          Long quantidadeEntrega, String responsavelEntrega, Funcionario funcionario,
                          Estoque estoque) {
